//Leetcode July Streak Day 3/31

/* 
Problem :- 376. Wiggle Subsequence[M]
...
The first difference (if one exists) may be either positive or negative. A sequence with one element and
